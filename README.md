...
![postgres](https://img.shields.io/badge/-Postgres-informational)
![mysql](https://img.shields.io/badge/-MySQL-success)
![bun](https://img.shields.io/badge/-Bun-red)
![elysia](https://img.shields.io/badge/-Elysia-blueviolet)
...
![swift](https://img.shields.io/badge/-Swift-informational)
![kubernetes](https://img.shields.io/badge/-Kubernetes-success)
![nginx](https://img.shields.io/badge/-Nginx-blueviolet)
![cloudflare](https://img.shields.io/badge/-Cloudflare-red)
...
📦 DevOps enthusiast, working with: **Docker**, **Kubernetes**, **Lens**, **Prometheus**, **Ingress**, **Grafana**, **Nginx**, **Cloudflare**, **ArgoCD**, **Grafana**, **Ansible**.  
